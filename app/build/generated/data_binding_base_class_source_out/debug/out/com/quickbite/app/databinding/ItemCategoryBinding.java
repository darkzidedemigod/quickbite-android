...
public final class ItemCategoryBinding implements ViewBinding {
  ...
  private ItemCategoryBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView categoryImage,
  ...
  public static ItemCategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemCategoryBinding((ConstraintLayout) rootView, categoryImage, categoryName);
    }
